...
import com.example.newsappmvvm.db.NewsResponse
...
class NewsViewModel (
    ...
    private fun handleBreakNewsReponse(response: Response<NewsResponse>): Resource<NewsResponse> {
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            if (hasInternetConnection()){
                ...
                breakingNews.postValue(handleBreakNewsReponse(response))
            } else{
